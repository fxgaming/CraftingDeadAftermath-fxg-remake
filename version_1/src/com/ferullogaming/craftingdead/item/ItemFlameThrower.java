...
import com.ferullogaming.craftingdead.network.CDAPacketFTClient;
import com.ferullogaming.craftingdead.network.CDAPacketFTTrigger;
import com.ferullogaming.craftingdead.network.CDAPacketFTTriggerStop;
         ...
         if (player.getCurrentEquippedItem() == itemstack) {
            ...
            if (rightHeld) {
               ...
               if (this.hasFuel(itemstack) && this.tickFireClient++ > 1.0D) {
                  CDAftermath.instance.getClientEvents().applyFlameThrowerParticles(itemstack, world, player);
               }
            }
