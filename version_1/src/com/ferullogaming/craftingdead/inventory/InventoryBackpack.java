...
public class InventoryBackpack implements IInventory {
   ...
   private EnumBackpackSize backpackSizeType;

   public InventoryBackpack(EnumBackpackSize par1, ItemStack par2) {
      this.backpackSizeType = par1;
      this.inventoryContents = new ItemStack[par1.backpackSlots];
      this.backpackStack = par2;
      this.loadInventory();
   }
   ...
   public void saveInventory() {
      NBTTagCompound nbt = this.getNBTTagCompound(this.backpackStack);
   ...
   public EnumBackpackSize getBackpackSizeType() {
      return this.backpackSizeType;
   }
}
