            ...
            if (var1) {
               ...
               if (entityHit != null && !entityHit.isDead) {
                  if (entityHit instanceof EntityLivingBase) {
                     CDAftermath.instance.getCommonEvents().applyBulletCollisionEntity(player, itemstack, (EntityLivingBase)entityHit, var3, vec3, world);
               ...
               if (blockid == checkID && blockid != 0) {
                  CDAftermath.instance.getCommonEvents().applyBulletCollisionBlock(player, itemstack, world, x, y, z, blockid, sidehit, vec3);
