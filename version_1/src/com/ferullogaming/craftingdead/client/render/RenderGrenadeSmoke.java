...
import com.ferullogaming.craftingdead.client.model.ModelGrenadeSmoke;
...
public class RenderGrenadeSmoke extends Render {
   public ModelBase grenadeModel = new ModelGrenadeSmoke();
   public String grenadeTexture = "grenadesmoke";

   public RenderGrenadeSmoke() {
   }

   public RenderGrenadeSmoke(String par1) {
