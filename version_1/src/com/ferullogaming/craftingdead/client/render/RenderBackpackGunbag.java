...
public class RenderBackpackGunbag extends RenderBackpack {
	public RenderBackpackGunbag(String par1, ModelBase par2) {
		super(par1, par2);
	}
	...
	public void renderBackpack(EntityPlayer par1, ItemStack par2) {
		...
		if (stack != null) {
			...
			GL11.glPushMatrix();
			GL11.glScalef(0.25f, 0.25f, 0.25f);
			GL11.glTranslatef(1.2f, 0.0f, -0.4f);
