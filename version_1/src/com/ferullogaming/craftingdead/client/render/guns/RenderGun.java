...
import com.ferullogaming.craftingdead.client.anim.GunAnimationPulled;
...
import com.ferullogaming.craftingdead.client.model.guns.ModelAS50;
import com.ferullogaming.craftingdead.client.model.guns.ModelFNFAL;
import com.ferullogaming.craftingdead.client.model.guns.ModelG18;
import com.ferullogaming.craftingdead.client.model.guns.ModelM107;
import com.ferullogaming.craftingdead.client.model.guns.ModelM1911;
import com.ferullogaming.craftingdead.client.model.guns.ModelM1Garand;
import com.ferullogaming.craftingdead.client.model.guns.ModelM240B;
import com.ferullogaming.craftingdead.client.model.guns.ModelM4A1;
import com.ferullogaming.craftingdead.client.model.guns.ModelM9;
import com.ferullogaming.craftingdead.client.model.guns.ModelMAC10;
import com.ferullogaming.craftingdead.client.model.guns.ModelMP5A4;
import com.ferullogaming.craftingdead.client.model.guns.ModelP90;
import com.ferullogaming.craftingdead.client.model.guns.ModelScarh;
import com.ferullogaming.craftingdead.client.model.guns.ModelSporter22;
import com.ferullogaming.craftingdead.client.model.guns.ModelTrenchGun;
...
public abstract class RenderGun implements IItemRenderer, IRenderPartialTick {
	...
	public void renderItem(ItemRenderType type, ItemStack itemstack, Object... data) {
		...
		if (itemstack != null) {
			...
			if (type == ItemRenderType.EQUIPPED_FIRST_PERSON) {
				if (CDAftermath.instance.playerDataHandler().getPlayerData(((EntityPlayer) entity).username).isAiming && ItemGun.instance().getAttachmentFromSlot(itemstack, 0) != null && ItemGun.instance().getAttachmentFromSlot(itemstack, 0).scopeTexture != null) {
					System.out.println("A TYPE");
					return;
				}
				if (!CDAftermath.instance.playerDataHandler().getPlayerData(((EntityPlayer) entity).username).isAiming) {
					...
					return;
				} else if (CDAftermath.instance.playerDataHandler().getPlayerData(((EntityPlayer)entity).username).isAiming) {
					if (Minecraft.getMinecraft().gameSettings.viewBobbing) {
	...
	private void applyGunModel() {
		if (this.gunModel != null) this.gunModel = this.getGunModel();
	}
