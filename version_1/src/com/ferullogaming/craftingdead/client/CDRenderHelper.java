...
public class CDRenderHelper {
	...
	private static RenderPlayer playerRenderer = new RenderPlayer();
	private static float zLevel = 0.0F;
	private static ResourceLocation rectTexture = new ResourceLocation("craftingdead:textures/gui/blank.png");
	...
	public static void drawTextureRect(int x, int y, int width, int height) {
		...
		int uw = 176;
		int uh = 146;
		mc.renderEngine.bindTexture(rectTexture);
