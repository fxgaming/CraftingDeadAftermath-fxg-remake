...
public class FakeCDWorld extends World {
   ...
   private static final ILogAgent dummyLogger = new FakeCDWorld.dudLog();

   public FakeCDWorld(EnumGameType type) {
      super(new FakeCDWorld.dudSave(), "pseudo", new FakeCDWorld.dudProvider(), new WorldSettings(0L, type, false, false, WorldType.DEFAULT), dummyProfiler, dummyLogger);
      this.setBlockArray(this.getDefaultIdArray());
      super.chunkProvider = new FakeCDWorld.dudCP(this);
   ...
   protected IChunkProvider createChunkProvider() {
      return new FakeCDWorld.dudCP(this);
   }
   ...
   private static final class dudCP implements IChunkProvider {
      private final FakeCDWorld theWorld;

      public dudCP(FakeCDWorld w) {
         this.theWorld = w;
      }
