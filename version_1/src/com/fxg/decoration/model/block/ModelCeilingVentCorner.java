...
public class ModelCeilingVentCorner extends ModelBase implements IModel {
    int x = 0;
    ...
    public ModelCeilingVentCorner() {
        ...
        this.Part_2.addBox(0.0f, 0.0f, 0.0f, 14, 7, 14);
        this.Part_2.setRotationPoint(-7.0f, -16.0f, -7.0f);
        ...
        this.Part_3.addBox(-0.5f, 0.0f, 0.0f, 1, 1, 21);
        this.Part_3.setRotationPoint(7.5f, -9.0f, -7.5f);
        this.Part_3.setTextureSize(64, 64);
        this.Part_3.mirror = true;
        this.setRotation(this.Part_3, 0.0f, -0.7853982f, 0.0f);
        this.Part_4 = new ModelRenderer((ModelBase)this, 33, 41);
        this.Part_4.addBox(0.0f, 0.0f, 0.0f, 1, 7, 14);
        ...
        this.Part_5 = new ModelRenderer((ModelBase)this, 25, 25);
        this.Part_5.addBox(0.0f, 0.0f, 0.0f, 14, 7, 1);
        this.Part_5.setRotationPoint(-7.0f, -16.0f, -8.0f);
