...
public class ModelMetalShelf extends ModelBase implements IModel {
    int x = 0;
	...
	public void render() {
        ...
        this.Import_Box11.render(f5);
        this.Import_Box12.render(f5);
        this.Import_Box13.render(f5);
        this.Import_Box14.render(f5);
        this.Import_Box15.render(f5);
	}
}
