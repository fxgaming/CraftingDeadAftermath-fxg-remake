...
import com.fxg.decoration.tile.TileInventoried;
import com.fxg.decoration.tile.TileSided;
...
public abstract class BlockSided extends BlockContainer {
	private final Random furnaceRand = new Random();

	public BlockSided(int id) {
	...
	public void onBlockPlacedBy(World world, int i, int j, int k, EntityLivingBase entityliving, ItemStack itemStack) {
		...
		if (te != null && te instanceof TileSided) {
			((TileSided) te).setFacing(facing);
	...
	public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6) {
		TileInventoried tileentityBase = (TileInventoried) par1World.getBlockTileEntity(par2, par3, par4);
