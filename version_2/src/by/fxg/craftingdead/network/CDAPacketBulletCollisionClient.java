         ...
         if (world.isRemote) {
            ...
            if (var1) {
               ...
               if (entityHit != null && !entityHit.isDead && entityHit instanceof EntityLivingBase) {
                  CDReloaded.instance.getClientEvents().applyBulletCollisionEntity((EntityLivingBase)entityHit, var3, vec3);
               }
            } else {
               blockid = stream.readInt();
               ...
               if (blockid == checkID && blockid != 0) {
                  CDReloaded.instance.getClientEvents().applyBulletCollisionBlock(world, x, y, z, blockid, sidehit, vec3);
               }
            }
         }
