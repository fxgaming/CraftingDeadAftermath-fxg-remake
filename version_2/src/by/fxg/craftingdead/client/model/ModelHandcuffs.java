...
public class ModelHandcuffs extends ModelBase {
   ...
   public boolean leftHandCuff = false;
   public boolean rightHandCuff = false;
   public boolean middleHandCuff = false;

   public ModelHandcuffs() {
      super.textureWidth = 64;
      super.textureHeight = 32;
      this.Shape1 = new ModelRenderer(this, 0, 0);
      this.Shape1.addBox(0.0F, 0.0F, 0.0F, 1, 2, 1);
      ...
      this.Shape2.setRotationPoint(-3.0F, -1.0F, 0.0F);
      this.Shape2.setTextureSize(64, 32);
      this.Shape2.mirror = true;
      this.setRotation(this.Shape2, 0.0F, 0.0F, 0.0F);
      this.Shape3 = new ModelRenderer(this, 0, 0);
      this.Shape3.addBox(0.0F, 0.0F, 0.0F, 2, 1, 1);
      this.Shape3.setRotationPoint(-3.0F, 2.0F, 0.0F);
      this.Shape3.setTextureSize(64, 32);
      this.Shape3.mirror = true;
      this.setRotation(this.Shape3, 0.0F, 0.0F, 0.0F);
      this.Shape4 = new ModelRenderer(this, 0, 0);
      this.Shape4.addBox(0.0F, 0.0F, 0.0F, 1, 2, 1);
      this.Shape4.setRotationPoint(-1.0F, 0.0F, 0.0F);
      ...
      this.Shape7.setRotationPoint(7.0F, 0.0F, 0.0F);
   ...
   public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
      ...
      if (this.leftHandCuff) {
         this.Shape1.render(f5);
         this.Shape2.render(f5);
         this.Shape3.render(f5);
         this.Shape4.render(f5);
         this.leftHandCuff = false;
      }

      if (this.rightHandCuff) {
         this.Shape5.render(f5);
         this.Shape6.render(f5);
         this.Shape7.render(f5);
         this.Shape8.render(f5);
         this.rightHandCuff = false;
      }

      if (this.middleHandCuff) {
         this.Shape9.render(f5);
         this.middleHandCuff = false;
      }
