         ...
         if (this.musicInterval++ >= this.maxMusicInterval) {
            ...
            if (!this.sndSystem.playing("BgMusic2")) {
               try {
                  ...
                  String sound = "ambient_cd_" + (rand.nextInt(6) + 1);
                  SoundPoolEntry soundpoolentry = new SoundPoolEntry(sound + ".ogg", this.getClass().getResource("/assets/craftingdead/sound/" + sound + ".ogg"));
                  ...
                  System.out.println("Ambient Sound Handler has CRASHED! Please report to F3RULLO14");
