...
import by.fxg.craftingdead.client.render.RenderPlayerEvents;
...
public class ClientRenderPlayer extends RenderPlayer {
	...
	protected int setArmorModel(AbstractClientPlayer par1AbstractClientPlayer, int par2, float par3) {
		PlayerData data = CDReloaded.instance.playerDataHandler().getPlayerData(par1AbstractClientPlayer);
	...
	public ResourceLocation getEntityTexture(Entity var1) {
		PlayerData playerData = CDReloaded.instance.playerDataHandler().getPlayerData((AbstractClientPlayer) var1);
