...
import by.fxg.craftingdead.client.render.guns.IRenderPartialTick;
...
public class RenderEvents {
	...
	public void onPlayerNameFormated(NameFormat event) {
		if (Minecraft.getMinecraft() != null && Minecraft.getMinecraft().thePlayer != null) {
			PlayerData dataDisplayed = CDReloaded.instance.playerDataHandler().getPlayerData(event.username);
	...
	public void onRenderLivingTag(Pre event) {
		if (Minecraft.getMinecraft() != null && Minecraft.getMinecraft().thePlayer != null) {
			...
			PlayerData data = CDReloaded.instance.playerDataHandler().getPlayerData(mcPlayer.username);
			...
			PlayerData data2 = CDReloaded.instance.playerDataHandler().getPlayerData(event.entityPlayer.username);
