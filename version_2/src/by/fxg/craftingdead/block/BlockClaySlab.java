...
public class BlockClaySlab extends BlockHalfSlab {
   ...
   public void registerIcons(IconRegister par1IconRegister) {
      ...
      if (this.isFirst) {
         for(i = 0; i < 7; ++i) {
            this.iconArray[i] = par1IconRegister.registerIcon("craftingdead:clay/hardened_clay_stained_" + ItemDye.dyeColorNames[getDyeFromBlock(i)].toLowerCase());
         }
      } else {
         for(i = 0; i < 8; ++i) {
            this.iconArray2[i] = par1IconRegister.registerIcon("craftingdead:clay/hardened_clay_stained_" + ItemDye.dyeColorNames[getDyeFromBlock(i + 7)].toLowerCase());
         }
      }
