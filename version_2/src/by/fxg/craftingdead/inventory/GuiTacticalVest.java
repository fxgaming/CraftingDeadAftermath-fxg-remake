...
public class GuiTacticalVest extends GuiContainer {
   ...
   public GuiTacticalVest(IInventory par1IInventory, IInventory par2IInventory) {
      super(new ContainerTacticalVest(par1IInventory, par2IInventory));
