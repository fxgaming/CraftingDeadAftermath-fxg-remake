...
public class BukkitUtils {
   ...
   public static void increaseWaterLevelsToPlayer(String par1, int par2) {
      if (FMLCommonHandler.instance().getSide() == Side.SERVER) {
    	  CDReloaded.instance.playerDataHandler().getPlayerData(par1).getWaterLevels().increaseWaterLevels(par2);
      }
   }

   public static void setCanViewPlayerTag(String par1, boolean par2) {
      if (FMLCommonHandler.instance().getSide() == Side.SERVER) {
    	  CDReloaded.instance.playerDataHandler().getPlayerData(par1).canViewUsername = par2;
      }
   }

   public static void setCanTakeBulletDamage(String par1, boolean par2) {
      if (FMLCommonHandler.instance().getSide() == Side.SERVER) {
    	  CDReloaded.instance.playerDataHandler().getPlayerData(par1).canTakeBulletDamage = par2;
      }
   }

   public static void setCanTakeBloodDamage(String par1, boolean par2) {
      if (FMLCommonHandler.instance().getSide() == Side.SERVER) {
    	  CDReloaded.instance.playerDataHandler().getPlayerData(par1).canTakeBloodDamage = par2;
      }
   }

   public static void setCanTakeInfectionDamage(String par1, boolean par2) {
      if (FMLCommonHandler.instance().getSide() == Side.SERVER) {
    	  CDReloaded.instance.playerDataHandler().getPlayerData(par1).canTakeInfectionDamage = par2;
      }
   }

   public static void setCanThrowGrenades(String par1, boolean par2) {
      if (FMLCommonHandler.instance().getSide() == Side.SERVER) {
    	  CDReloaded.instance.playerDataHandler().getPlayerData(par1).canThrowGrenades = par2;
      }
   }
}
